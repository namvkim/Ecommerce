...
<body>
        ...
        <div class="container content-input content-input-wrap">
            ...
            <form action="" method="POST" id="myform">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" id="name" placeholder="Fullname *" name="name" value="<?php if (isset($_POST['name'])) {
                                                                                                                        echo $_POST["name"];
                                                                                                                    } ?>">
                </div>

                <div class="form-group">
                    <input type="password" class="form-control" id="pass1" placeholder="Password *" name="pass1" value="<?php if (isset($_POST['pass1'])) {
                                                                                                                            echo $_POST["pass1"];
                                                                                                                        } ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="email" class="form-control" id="email" placeholder="Email *" name="email" value="<?php if (isset($_POST['email'])) {
                                                                                                                        echo $_POST["email"];
                                                                                                                    } ?>">
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" id="phone" placeholder="Phone number *" name="phone" value="<?php if (isset($_POST['phone'])) {
                                                                                                                                echo $_POST["phone"];
                                                                                                                            } ?>">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="address" placeholder="Address *" name="address" value="<?php if (isset($_POST['address'])) {
                                                                                                                            echo $_POST["address"];
                                                                                                                        } ?>">
                </div>
    ...
    if (isset($_POST['btn'])) {
        if (
            !empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['pass1']) && !empty($_POST['pass2'])
